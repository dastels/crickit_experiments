...
#define SS_INPUT_PULLUP      0x02
#define SS_INPUT_PULLDOWN_16 0x04 // PULLDOWN only possible for pin16
#define SS_OUTPUT            0x01
#define SS_OUTPUT_OPEN_DRAIN 0x03
#define SS_WAKEUP_PULLUP     0x05
#define SS_WAKEUP_PULLDOWN   0x07
...
protected:
  ...
  int _fd;                      // the file descriptor returned by wiringPiI2C

  void      write8(uint8_t regHigh, uint8_t regLow, uint8_t value);
  uint8_t   read8(uint8_t regHigh, uint8_t regLow, uint16_t delay = 125);
